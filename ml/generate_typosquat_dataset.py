...
COMMON_WORDS = [
    'online', 'login', 'secure', 'app', 'pay', 'bank', 'money',
    'myanmar', 'mm', 'verify', 'account', 'update', 'bonus',
    'claim', 'free', 'gift', 'support', 'service', 'official'
]

# Leetspeak mapping for homoglyph (ဂဏန်းအသုံးပြုထားသော)
LEET_MAP = {'a': '4', 'e': '3', 'i': '1', 'l': '1', 'o': '0', 's': '5', 'b': '8', 'g': '9'}
...
def generate_typosquats(brand_norm: str) -> set:
    ...
    similar = {
        'a': 'e', 'e': 'a', 'o': '0', '0': 'o', 'l': '1', '1': 'l',
        'i': 'l', 'l': 'i', 'b': 'd', 'd': 'b', 'm': 'n', 'n': 'm',
        'v': 'w', 'w': 'v', 's': '5', '5': 's', 'z': 's', 's': 'z'
    }
